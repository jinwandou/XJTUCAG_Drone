...
class DroneControl
{
  public:
    ...
    static constexpr float SAFETY_ALTITUDE_GPS = 5.0;
    ...
    geometry_msgs::PoseStamped det_position;
    ...
    void land();
    void disarm();
    void det_position_cb(const prometheus_msgs::DetectionInfo::ConstPtr &msg);
